...
public final class TableOfContents {
    ...
    private void readHeader(Dex.Section headerIn) throws UnsupportedEncodingException {
        ...
        if (!com.pranav.ide.dex.DexFormat.isSupportedDexMagic(magic)) {
            String msg =
        ...
        apiLevel = com.pranav.ide.dex.DexFormat.magicToApi(magic);
        checksum = headerIn.readInt();
        signature = headerIn.readByteArray(20);
        fileSize = headerIn.readInt();
        int headerSize = headerIn.readInt();
        if (headerSize != com.pranav.ide.dex.SizeOf.HEADER_ITEM) {
            throw new DexException("Unexpected header: 0x" + Integer.toHexString(headerSize));
        }
        int endianTag = headerIn.readInt();
        if (endianTag != com.pranav.ide.dex.DexFormat.ENDIAN_TAG) {
    ...
    public void writeHeader(Dex.Section out, int api) throws IOException {
        out.write(com.pranav.ide.dex.DexFormat.apiToMagic(api).getBytes("UTF-8"));
