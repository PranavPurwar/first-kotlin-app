...
import com.pranav.ide.dex.util.Unsigned;
...
public final class MethodId implements Comparable<MethodId> {
    ...
    public int compareTo(MethodId other) {
        if (declaringClassIndex != other.declaringClassIndex) {
            return com.pranav.ide.dex.util.Unsigned.compare(declaringClassIndex, other.declaringClassIndex);
        }
        if (nameIndex != other.nameIndex) {
            return com.pranav.ide.dex.util.Unsigned.compare(nameIndex, other.nameIndex);
        }
