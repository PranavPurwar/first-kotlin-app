...
public interface ParseObserver {
     ...
     */
    public void startParsingMember(com.pranav.ide.dx.util.ByteArray bytes, int offset, String name,
                                   String descriptor);
     ...
     */
    public void endParsingMember(com.pranav.ide.dx.util.ByteArray bytes, int offset, String name,
