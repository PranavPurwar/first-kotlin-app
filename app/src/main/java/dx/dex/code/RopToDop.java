...
public final class RopToDop {
    ...
    public static com.pranav.ide.dx.dex.code.Dop dopFor(Insn insn) {
        ...
        switch (rop.getOpcode()) {
            case com.pranav.ide.dx.rop.code.RegOps.MOVE_EXCEPTION:     return com.pranav.ide.dx.dex.code.Dops.MOVE_EXCEPTION;
            case com.pranav.ide.dx.rop.code.RegOps.INVOKE_STATIC:      return com.pranav.ide.dx.dex.code.Dops.INVOKE_STATIC;
            case com.pranav.ide.dx.rop.code.RegOps.INVOKE_VIRTUAL:     return com.pranav.ide.dx.dex.code.Dops.INVOKE_VIRTUAL;
            case com.pranav.ide.dx.rop.code.RegOps.INVOKE_SUPER:       return com.pranav.ide.dx.dex.code.Dops.INVOKE_SUPER;
            case com.pranav.ide.dx.rop.code.RegOps.INVOKE_DIRECT:      return com.pranav.ide.dx.dex.code.Dops.INVOKE_DIRECT;
            case com.pranav.ide.dx.rop.code.RegOps.INVOKE_INTERFACE:   return com.pranav.ide.dx.dex.code.Dops.INVOKE_INTERFACE;
            case com.pranav.ide.dx.rop.code.RegOps.INVOKE_POLYMORPHIC: return com.pranav.ide.dx.dex.code.Dops.INVOKE_POLYMORPHIC;
            case com.pranav.ide.dx.rop.code.RegOps.INVOKE_CUSTOM:      return com.pranav.ide.dx.dex.code.Dops.INVOKE_CUSTOM;
            case com.pranav.ide.dx.rop.code.RegOps.NEW_ARRAY:          return com.pranav.ide.dx.dex.code.Dops.NEW_ARRAY;
            case com.pranav.ide.dx.rop.code.RegOps.FILLED_NEW_ARRAY:   return com.pranav.ide.dx.dex.code.Dops.FILLED_NEW_ARRAY;
            case com.pranav.ide.dx.rop.code.RegOps.FILL_ARRAY_DATA:    return com.pranav.ide.dx.dex.code.Dops.FILL_ARRAY_DATA;
            ...
            case com.pranav.ide.dx.rop.code.RegOps.GET_FIELD: {
                ...
                switch (basicType) {
                    case com.pranav.ide.dx.rop.type.Type.BT_BOOLEAN: return com.pranav.ide.dx.dex.code.Dops.IGET_BOOLEAN;
                    case com.pranav.ide.dx.rop.type.Type.BT_BYTE:    return com.pranav.ide.dx.dex.code.Dops.IGET_BYTE;
                    case com.pranav.ide.dx.rop.type.Type.BT_CHAR:    return com.pranav.ide.dx.dex.code.Dops.IGET_CHAR;
                    case com.pranav.ide.dx.rop.type.Type.BT_SHORT:   return com.pranav.ide.dx.dex.code.Dops.IGET_SHORT;
                    case com.pranav.ide.dx.rop.type.Type.BT_INT:     return com.pranav.ide.dx.dex.code.Dops.IGET;
                }
                break;
            }
            case com.pranav.ide.dx.rop.code.RegOps.PUT_FIELD: {
                ...
                int basicType = ref.getBasicType();
                switch (basicType) {
                    case com.pranav.ide.dx.rop.type.Type.BT_BOOLEAN: return com.pranav.ide.dx.dex.code.Dops.IPUT_BOOLEAN;
                    case com.pranav.ide.dx.rop.type.Type.BT_BYTE:    return com.pranav.ide.dx.dex.code.Dops.IPUT_BYTE;
                    case com.pranav.ide.dx.rop.type.Type.BT_CHAR:    return com.pranav.ide.dx.dex.code.Dops.IPUT_CHAR;
                    case com.pranav.ide.dx.rop.type.Type.BT_SHORT:   return com.pranav.ide.dx.dex.code.Dops.IPUT_SHORT;
                    case com.pranav.ide.dx.rop.type.Type.BT_INT:     return com.pranav.ide.dx.dex.code.Dops.IPUT;
                }
                break;
            }
            case com.pranav.ide.dx.rop.code.RegOps.GET_STATIC: {
                ...
                int basicType = ref.getBasicType();
                switch (basicType) {
                    case com.pranav.ide.dx.rop.type.Type.BT_BOOLEAN: return com.pranav.ide.dx.dex.code.Dops.SGET_BOOLEAN;
                    case com.pranav.ide.dx.rop.type.Type.BT_BYTE:    return com.pranav.ide.dx.dex.code.Dops.SGET_BYTE;
                    case com.pranav.ide.dx.rop.type.Type.BT_CHAR:    return com.pranav.ide.dx.dex.code.Dops.SGET_CHAR;
                    case com.pranav.ide.dx.rop.type.Type.BT_SHORT:   return com.pranav.ide.dx.dex.code.Dops.SGET_SHORT;
                    case com.pranav.ide.dx.rop.type.Type.BT_INT:     return com.pranav.ide.dx.dex.code.Dops.SGET;
                }
                break;
            }
            case com.pranav.ide.dx.rop.code.RegOps.PUT_STATIC: {
                ...
                int basicType = ref.getBasicType();
                switch (basicType) {
                    case com.pranav.ide.dx.rop.type.Type.BT_BOOLEAN: return com.pranav.ide.dx.dex.code.Dops.SPUT_BOOLEAN;
                    case com.pranav.ide.dx.rop.type.Type.BT_BYTE:    return com.pranav.ide.dx.dex.code.Dops.SPUT_BYTE;
                    case com.pranav.ide.dx.rop.type.Type.BT_CHAR:    return com.pranav.ide.dx.dex.code.Dops.SPUT_CHAR;
                    case com.pranav.ide.dx.rop.type.Type.BT_SHORT:   return com.pranav.ide.dx.dex.code.Dops.SPUT_SHORT;
                    case Type.BT_INT:     return com.pranav.ide.dx.dex.code.Dops.SPUT;
                }
                break;
            }
            case RegOps.CONST: {
