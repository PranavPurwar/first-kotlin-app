...
public abstract class InsnFormat {
    ...
    protected static String literalBitsComment(CstLiteralBits value,
        ...
        switch (width) {
            case 4:  sb.append(com.pranav.ide.dx.util.Hex.uNibble((int) bits)); break;
            case 8:  sb.append(com.pranav.ide.dx.util.Hex.u1((int) bits));      break;
            case 16: sb.append(com.pranav.ide.dx.util.Hex.u2((int) bits));      break;
            case 32: sb.append(com.pranav.ide.dx.util.Hex.u4((int) bits));      break;
            case 64: sb.append(com.pranav.ide.dx.util.Hex.u8(bits));            break;
            default: {
