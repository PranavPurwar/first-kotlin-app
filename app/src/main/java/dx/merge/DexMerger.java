...
public final class DexMerger {
    ...
    private void mergeStringIds() {
        new IdMerger<String>(idsDefsOut) {
            ...
            @Override String read(Dex.Section in, com.pranav.ide.dx.merge.IndexMap indexMap, int index) {
                return in.readString();
            }

            @Override void updateIndex(int offset, com.pranav.ide.dx.merge.IndexMap indexMap, int oldIndex, int newIndex) {
    ...
    private void mergeTypeIds() {
        new IdMerger<Integer>(idsDefsOut) {
            ...
            @Override Integer read(Dex.Section in, com.pranav.ide.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeTypeLists() {
        new IdMerger<TypeList>(typeListOut) {
            ...
            @Override TypeList read(Dex.Section in, com.pranav.ide.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeProtoIds() {
        new IdMerger<ProtoId>(idsDefsOut) {
            ...
            @Override ProtoId read(Dex.Section in, com.pranav.ide.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeFieldIds() {
        new IdMerger<FieldId>(idsDefsOut) {
            ...
            @Override FieldId read(Dex.Section in, com.pranav.ide.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeMethodIds() {
        new IdMerger<MethodId>(idsDefsOut) {
            ...
            @Override MethodId read(Dex.Section in, com.pranav.ide.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeAnnotations() {
        new IdMerger<Annotation>(annotationOut) {
            ...
            @Override Annotation read(Dex.Section in, com.pranav.ide.dx.merge.IndexMap indexMap, int index) {
