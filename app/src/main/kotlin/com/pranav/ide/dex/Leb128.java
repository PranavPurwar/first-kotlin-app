...
public final class Leb128 {
     ...
     */
    public static int readSignedLeb128(com.pranav.ide.dex.util.ByteInput in) {
        int result = 0;
        int cur;
        int count = 0;
        int signBits = -1;
     ...
     */
    public static void writeUnsignedLeb128(com.pranav.ide.dex.util.ByteOutput out, int value) {
        int remaining = value >>> 7;
