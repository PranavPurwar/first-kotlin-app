...
public final class MixedItemSection extends Section {
    ...
    private static final Comparator<com.pranav.ide.dx.dex.file.OffsettedItem> TYPE_SORTER =
        new Comparator<com.pranav.ide.dx.dex.file.OffsettedItem>() {
        @Override
        public int compare(com.pranav.ide.dx.dex.file.OffsettedItem item1, com.pranav.ide.dx.dex.file.OffsettedItem item2) {
    ...
    public MixedItemSection(String name, com.pranav.ide.dx.dex.file.DexFile file, int alignment,
        ...
        this.items = new ArrayList<com.pranav.ide.dx.dex.file.OffsettedItem>(100);
        this.interns = new HashMap<com.pranav.ide.dx.dex.file.OffsettedItem, com.pranav.ide.dx.dex.file.OffsettedItem>(100);
        this.sort = sort;
        this.writeSize = -1;
    }
    ...
    public void writeIndexAnnotation(AnnotatedOutput out, ItemType itemType,
        ...
        TreeMap<String, com.pranav.ide.dx.dex.file.OffsettedItem> index =
            new TreeMap<String, com.pranav.ide.dx.dex.file.OffsettedItem>();
