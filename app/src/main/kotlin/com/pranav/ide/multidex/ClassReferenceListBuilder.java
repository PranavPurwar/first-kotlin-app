...
public class ClassReferenceListBuilder {
    ...
    private final com.pranav.ide.multidex.Path path;
    private final Set<String> classNames = new HashSet<String>();

    public ClassReferenceListBuilder(com.pranav.ide.multidex.Path path) {
        this.path = path;
    }

    /**
     * Kept for compatibility with the gradle integration, this method just forwards to
     * {@link com.pranav.ide.multidex.MainDexListBuilder#main(String[])}.
     * @deprecated use {@link com.pranav.ide.multidex.MainDexListBuilder#main(String[])} instead.
     */
    @Deprecated
